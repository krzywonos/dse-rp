...
<xsl:stylesheet xpath-default-namespace="http://www.tei-c.org/ns/1.0"
	...
	<!-- default: '' -->
	<xsl:param name="webSite" select="'https://krzywonos.github.io/dse-rp'"/>

	<!-- EN: Index title -->
	<!-- IT: Titolo edizione -->
	<!-- default: 'Codex Viewer' -->
	<xsl:param name="index_title" select="'Rozmyślanie przemyskie'"/>
	...
	<xsl:param name="welcomeMsg">
		...
		<div>
			This is a partial digital edition of Rozmyślanie przemyskie, the first known book fully written in Polish. The edition was created as a deliverable for the Digital Scholarly Editing - Theory, Methods and Practices headed by Prof. Paola Italia at Alma Mater Studiorum - Universita` di Bologna, AA 2024/25.
		</div>
	</xsl:param>
